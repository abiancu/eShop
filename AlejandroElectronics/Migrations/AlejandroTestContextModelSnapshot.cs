...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.LineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.Products", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.LineItem", b =>
                {
                    b.HasOne("AlejandroElectronics.Models.Orders", "Order")
                        .WithMany("LineItems")
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.Payments", b =>
                {
                    b.HasOne("AlejandroElectronics.Models.Orders", "Orders")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("AlejandroElectronics.Models.Shipping", b =>
                {
                    b.HasOne("AlejandroElectronics.Models.Address", "Address")
                        .WithMany("Shipping")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AlejandroElectronics.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
