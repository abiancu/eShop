...
namespace AlejandroElectronics.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Rating,Body,IsApproved")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Rating,Body,IsApproved")] Review review)
        {
            if (id != review.ID)
            {
                return NotFound();
